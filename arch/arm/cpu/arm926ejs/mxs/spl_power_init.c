...
static void mxs_power_configure_power_source(void)
{
	...
	mxs_src_power_init();
#if 0 // ssen - this is to ensure that batt boot takes place and not 5V boot. Strange error (board will not boot without the serial port connected - VDD was 3.39V instead of 3.29V)
	if (readl(&power_regs->hw_power_sts) & POWER_STS_VDD5V_GT_VDDIO) {
